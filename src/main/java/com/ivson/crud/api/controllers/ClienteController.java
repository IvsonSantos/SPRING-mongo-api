package com.ivson.crud.api.controllers;
...
import com.ivson.crud.api.responses.Response;
import com.ivson.crud.api.services.ClienteService;

/**
 * Disponibiliza como um controller do tipo REST, para ser acessado como um ENDPOINT e disponibilar a API
 * 
 * @author ivson.santos
 *
 */
...
public class ClienteController {
	...
	/**
	 * @RequestBodu automaticamente extrai o que vem do corpo e tranforma em um objeto do tipo
	 * @BindingResult para pegar se houver esrros na validacao
	 * @valid para rodar as validacoes da entidade
	 * @param cliente
	 * @return
	 */
	@PostMapping	
